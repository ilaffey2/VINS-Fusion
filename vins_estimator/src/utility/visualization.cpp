...
void pubPointCloud(const Estimator &estimator, const std_msgs::Header &header)
{
    ...
    // Initialize a channel for feature IDs
    ...
    for (auto &it_per_id : estimator.f_manager.feature)
    {
        ...
        // Add the feature ID to the channel
        id_channel.values.push_back(static_cast<float>(it_per_id.feature_id));
    }

    // Add the ID channel to the point cloud
    point_cloud.channels.push_back(id_channel);
